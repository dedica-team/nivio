...
it('should not change values', () => {
  ...
  const centerCoordinates = MapUtils.getCenterCoordinates(value, '1000', '1000');
...
it('should change lower x', () => {
  ...
  const centerCoordinates = MapUtils.getCenterCoordinates(value, '100', '1000');
...
it('should change upper x', () => {
  ...
  const centerCoordinates = MapUtils.getCenterCoordinates(value, '1999', '1000');
...
it('should change lower y', () => {
  ...
  const centerCoordinates = MapUtils.getCenterCoordinates(value, '1000', '100');
  expect(centerCoordinates.x).toBe(1000);
...
it('should change upper y', () => {
  ...
  const centerCoordinates = MapUtils.getCenterCoordinates(value, '1000', '1999');
  expect(centerCoordinates.x).toBe(1000);
