...
class NPath extends Component {
    ...
    marker(pos, fillId) {
        ...
        if (pos.tangentX < 0 && pos.tangentY > 0) //TODO check
            degrees +=180;

        let transform = 'translate(' + Math.floor(pos.x) + ' ' + pos.y + ') rotate(' + degrees + ' 0 0)';
        return (
            <text x="-10" y="0" fill={fillId} width="10" height="10" transform={transform}>&#10148;</text>
        );
    }
}
