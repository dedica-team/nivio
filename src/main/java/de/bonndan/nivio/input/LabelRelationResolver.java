...
public class LabelRelationResolver extends Resolver {
    ...
    private List<Hint> getHints(
        ...
        return itemDescription.getLabels().entrySet().stream()
                ...
                .map(entry -> hintFactory.create(landscape, itemDescription, entry.getKey(), entry.getValue()))
    ...
    /**
     * @param blacklist configured matchers
     ...
     * @param hint             hint
     */
    private void applyDescriptionsFromHint(ItemDescriptions itemDescriptions, Hint hint) {
