...
@Schema(description = "A directed relation between to landscape items. Also known as edge in a directed graph.")
public class RelationDescription {

    @Schema(description = "The type of the relation, i.e. whether is it a hard dependency or a soft dependency.")
