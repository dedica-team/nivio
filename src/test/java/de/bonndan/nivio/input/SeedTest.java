...
public class SeedTest {
    ...
    public void twoLocal() throws MalformedURLException {
        ...
        Seed seed = new Seed(java.util.Optional.of(root + "/src/test/resources/example/example_env.yml," + root + "/src/test/resources/example/inout.yml"), null);
    ...
    public void http() {
        Path currentRelativePath = Paths.get("");
        String root = currentRelativePath.toAbsolutePath().toString();
        Seed seed = new Seed(java.util.Optional.of(root + "/src/test/resources/example/example_env.yml,http://somehost.com/somefile.yml"), null);
        List<URL> locations = seed.getLocations();
    ...
    @Test
    public void fails() {
        assertThrows(RuntimeException.class, () -> new Seed(java.util.Optional.of(" :xxx"), null));
    }
}
