...
class InputFormatHandlerKubernetesTest {
    ...
    void applyData() throws MalformedURLException {
        ...
        assertThat(landscapeDescription.getIndexReadAccess().matchOneByIdentifiers(identifierMap.get("deployment"), "deployment", ItemDescription.class).orElseThrow().getRelations().size()).isZero();
        assertThat(landscapeDescription.getIndexReadAccess().matchOneByIdentifiers(identifierMap.get("replicaSet"), "deployment", ItemDescription.class).orElseThrow().getRelations().stream().findFirst().orElseThrow().getSource()).isEqualTo(identifierMap.get("deployment"));
        assertThat(landscapeDescription.getIndexReadAccess().matchOneByIdentifiers(identifierMap.get("replicaSet"), "deployment", ItemDescription.class).orElseThrow().getRelations().stream().findFirst().orElseThrow().getTarget()).isEqualTo(identifierMap.get("replicaSet"));
        assertThat(landscapeDescription.getIndexReadAccess().matchOneByIdentifiers(identifierMap.get("pod"), "deployment", ItemDescription.class).orElseThrow().getRelations().stream().findFirst().orElseThrow().getSource()).isEqualTo(identifierMap.get("replicaSet"));
        assertThat(landscapeDescription.getIndexReadAccess().matchOneByIdentifiers(identifierMap.get("pod"), "deployment", ItemDescription.class).orElseThrow().getRelations().stream().findFirst().orElseThrow().getTarget()).isEqualTo(identifierMap.get("pod"));
        assertThat(landscapeDescription.getIndexReadAccess().matchOneByIdentifiers(identifierMap.get("service"), "deployment", ItemDescription.class).orElseThrow().getRelations().stream().findFirst().orElseThrow().getSource()).isEqualTo(identifierMap.get("deployment"));
        assertThat(landscapeDescription.getIndexReadAccess().matchOneByIdentifiers(identifierMap.get("service"), "deployment", ItemDescription.class).orElseThrow().getRelations().stream().findFirst().orElseThrow().getTarget()).isEqualTo(identifierMap.get("service"));
        assertThat(landscapeDescription.getIndexReadAccess().matchOneByIdentifiers(identifierMap.get("persistentVolume"), "deployment", ItemDescription.class).orElseThrow().getRelations().stream().findFirst().orElseThrow().getSource()).isEqualTo(identifierMap.get("persistentVolumeClaim"));
        assertThat(landscapeDescription.getIndexReadAccess().matchOneByIdentifiers(identifierMap.get("persistentVolume"), "deployment", ItemDescription.class).orElseThrow().getRelations().stream().findFirst().orElseThrow().getTarget()).isEqualTo(identifierMap.get("persistentVolume"));
        assertThat(landscapeDescription.getIndexReadAccess().matchOneByIdentifiers(identifierMap.get("persistentVolumeClaim"), "deployment", ItemDescription.class).orElseThrow().getRelations().stream().findFirst().orElseThrow().getSource()).isEqualTo(identifierMap.get("pod"));
        assertThat(landscapeDescription.getIndexReadAccess().matchOneByIdentifiers(identifierMap.get("persistentVolumeClaim"), "deployment", ItemDescription.class).orElseThrow().getRelations().stream().findFirst().orElseThrow().getTarget()).isEqualTo(identifierMap.get("persistentVolumeClaim"));
        assertThat(landscapeDescription.getIndexReadAccess().matchOneByIdentifiers(identifierMap.get("persistentVolumeClaim"), "deployment", ItemDescription.class).orElseThrow().getRelations().stream().findFirst().orElseThrow().getSource()).isEqualTo(identifierMap.get("pod"));
        assertThat(landscapeDescription.getIndexReadAccess().matchOneByIdentifiers(identifierMap.get("persistentVolumeClaim"), "deployment", ItemDescription.class).orElseThrow().getRelations().stream().findFirst().orElseThrow().getTarget()).isEqualTo(identifierMap.get("persistentVolumeClaim"));
    }
