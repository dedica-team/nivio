...
# See https://blog.codecentric.de/en/2020/06/spring-boot-graalvm-native-image-maven-plugin/
...
time native-image \
  ...
  --initialize-at-build-time=org.springframework.util.MimeType \
  --initialize-at-build-time=org.springframework.hateoas.MediaTypes \
  --initialize-at-build-time=org.springframework.util.MimeTypeUtils \
  -cp $CP $MAINCLASS;
